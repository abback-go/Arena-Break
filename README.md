...
명지전문대 AI게임SW학과 · 3장 모듈 (수업 2회 · 나머지는 과제)
...
| 장 | 게임 기능 | AI 협업 역량 |
|---|---|---|
| 1장 | 플레이어 이동 + 사격 | **컨텍스트 설계** — `CLAUDE.md`, 명세 우선 |
| 2장 | 적 AI + 웨이브 시스템 | **작업 분할과 검증** — 작게 요청, 즉시 테스트 |
| 3장 | UX 폴리시 + 빌드 | **코드 리뷰와 판단** — AI 코드 읽고 고치기 |
...
한 세션이 그 문서 하나로 진행됩니다. 프롬프트, 씬 세팅, 검증 체크리스트가 전부 들어 있습니다.
...
reference/    필요 패키지 목록
CLAUDE.md     ← Claude Code가 읽는 프로젝트 규약. 1장에서 함께 다듬습니다
```
...
- **[docs/00-SETUP.md](docs/00-SETUP.md)** — 환경 세팅 (수업 전 필수)
- **[docs/01-WEEK1.md](docs/01-WEEK1.md)** — **1장 실습 진행** (이동 + 사격) ← 수업 당일 이 문서를 엽니다
- **[docs/02-WEEK2.md](docs/02-WEEK2.md)** — **2장 실습 진행** (적 AI + 웨이브)
- **[docs/03-WEEK3.md](docs/03-WEEK3.md)** — **3장 실습 진행** (상태 머신 + HUD + AI 코드 리뷰)
